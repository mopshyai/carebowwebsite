...
import {
  ...
  Save, User, Mail, Phone, MapPin, Bell, Lock, Shield, CheckCircle
} from "lucide-react";
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-primary-700 via-primary-600 to-primary-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-200 text-lg">Manage your account preferences</p>
            </div>
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Receive email alerts for appointments</p>
                    </div>
                  </div>
                  <input
                    type="checkbox"
                ...
                <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Caregiver Updates</p>
                      <p className="text-sm text-gray-600">Updates from your caregivers</p>
                    </div>
                  </div>
                  <input
                    type="checkbox"
                    checked={notifications.caregiverUpdates}
                    onChange={(e) => setNotifications({ ...notifications, caregiverUpdates: e.target.checked })}
                    className="w-5 h-5 text-primary-600 rounded focus:ring-2 focus:ring-primary-500"
                  />
                </label>
                ...
                <label className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Promotions and updates from Carebow</p>
                    </div>
                  </div>
                  <input
                    type="checkbox"
